...
@section('header', 'Buat Cabang Baru')

@section('content')
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="mb-6 pb-4 border-b border-gray-100">
            <h2 class="text-lg font-bold text-gray-800">Formulir Cabang Baru</h2>
        </div>
        ...
        <form action="{{ route('toko.store') }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="nama_toko" required placeholder="Contoh: Cabang Panam"
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3" required placeholder="Jalan..."
            ...
            <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-100">
                ...
                <button type="submit"
                    class="px-6 py-2 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700">Simpan Cabang</button>
            </div>
        </form>
    </div>
@endsection
